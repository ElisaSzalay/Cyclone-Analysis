...
title('Mean Surface Nitrate - Cyclone Fina')
exportgraphics(gcf, fullfile(outputFolder, 'Mean_Surface_Nitrate_Fina.png'));
...
title('STD Surface Nitrate - Cyclone Fina')
exportgraphics(gcf, fullfile(outputFolder, 'STD_Surface_Nitrate_Fina.png'));