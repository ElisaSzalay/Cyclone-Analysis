...
title('Mean Surface SPM - Cyclone Fina')

saveas(gcf,fullfile(output_dir,'SPM_Fina_mean.png'))
...
title('STD Surface SPM - Cyclone Fina')

saveas(gcf,fullfile(output_dir,'SPM_Fina_std.png'))
...
xlabel('Date')
ylabel('SPM (g m^{-3})')
title('Cyclone Fina Daily Mean SPM')
...
saveas(gcf,fullfile(output_dir,'SPM_Fina_timeseries.png'))
...
title(['Peak SPM Fina - ' datestr(peak_date)])

saveas(gcf,fullfile(output_dir,'SPM_Fina_peakmap.png'))
...
saveas(gcf,fullfile(output_dir,'SPM_Fina_regression.png'))
...
fina_anomaly = spm_mean - baseline_mean;
...
title('Fina SPM Anomaly vs Baseline')

saveas(gcf,fullfile(output_dir,'SPM_Fina_anomaly.png'))
...
fina_z = (spm_mean - baseline_mean) ./ baseline_std;
...
title('Fina Standardized SPM Anomaly (Z-score)')

saveas(gcf,fullfile(output_dir,'SPM_Fina_zscore.png'))
