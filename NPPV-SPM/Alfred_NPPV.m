...
title('Mean Surface NPPV - Cyclone Alfred')

saveas(gcf,fullfile(output_dir,'NPP_Alfred_mean.png'))
...
title('STD Surface NPPV - Cyclone Alfred')

saveas(gcf,fullfile(output_dir,'NPP_Alfred_std.png'))
...
xlabel('Date')
ylabel('NPPV')
title('Cyclone Alfred Daily Mean NPPV')

saveas(gcf,fullfile(output_dir,'NPP_Alfred_timeseries.png'))
...
title(['Peak NPPV Alfred - ' datestr(peak_date)])

saveas(gcf,fullfile(output_dir,'NPP_Alfred_peakmap.png'))
...
saveas(gcf,fullfile(output_dir,'NPP_Alfred_regression.png'))
...
alfred_anomaly = npp_mean - baseline_mean;
...
title('Alfred NPPV Anomaly vs Baseline')

saveas(gcf,fullfile(output_dir,'NPP_Alfred_anomaly.png'))
...
alfred_z = (npp_mean - baseline_mean) ./ baseline_std;
...
title('Alfred Standardized Anomaly (Z-score)')

saveas(gcf,fullfile(output_dir,'NPP_Alfred_zscore.png'))
