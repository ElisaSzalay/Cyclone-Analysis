...
title('Mean Surface Chlorophyll-a - Cyclone Fina')
exportgraphics(gcf, fullfile(outputFolder, 'Mean_Surface_Chlorophyll-a_Fina.png'));
%% STD map
...
title('STD Surface Chlorophyll-a - Cyclone Fina')
exportgraphics(gcf, fullfile(outputFolder, 'STD_Surface_Chlorophyll-a_Fina.png'));